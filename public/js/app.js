...
var update = __webpack_require__(18)("52962c14", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    showClearsuccessButton: function showClearsuccessButton() {
      return this.tasks.filter(function (todo) {
        return todo.success;
      }).length > 0;
    }
  ...
  methods: {
    ...
    get_tasks: function get_tasks() {
      ...
      this.error = '';
      var url = 'http://bd-lab.info/api/todos/';
      axios.get(url).then(function (response) {
        _this.tasks = response.data;
        _this.tasks.forEach(function (element) {
          if (element.success === '1') element.success = true;else element.success = false;

          if (element.editing === '1') element.editing = true;else element.editing = false;
        });
      }).catch(function (response) {
        _this.error = response.response.data;
      });
    },
    add_task: function add_task() {
      ...
      this.error = '';
      var url = 'http://bd-lab.info/api/todosp';
      axios.post(url, {
        name: this.new_task
        ...
        _this2.error = response.response.data;
      });
    },
    removeTodo: function removeTodo(item, index) {
      var _this3 = this;

      /* удаление  */

      axios.delete('http://bd-lab.info/api/todos/' + item.id).then(function (response) {
        _this3.tasks.splice(index, 1);
      }).catch(function (error) {
        _this3.error = response.response.data;
    ...
    doneEdit: function doneEdit(item) {
      ...
      axios.patch('http://bd-lab.info/api/todos/' + item.id, {
        ...
        _this4.error = response.response.data;
        console.log(_this4.error);
      });
    },
    editSuccess: function editSuccess(item) {
      var _this5 = this;

      /* успешна 1 задача или не успешна  роут такой же что для редактирования*/
      ...
      axios.patch('http://bd-lab.info/api/todos/' + item.id, {
        ...
        _this5.error = response.response.data;
    ...
    editTodo: function editTodo(item) {
      /* начало редактирования занесение кеш */
    ...
    checkAllTodos: function checkAllTodos() {
      ...
      /* все выполнились */
      this.tasks.forEach(function (todo) {
        return todo.success = event.target.checked;
      }); // цикл по всем true/false
      axios.patch('http://bd-lab.info/api/todosCheckAll', {
        complite: event.target.checked // тело запроса
      }).then(function (response) {}).catch(function (error) {
        _this6.error = response.response.data;
    ...
    clearsuccess: function clearsuccess() {
      ...
      /* удалить все выполненые */
      this.tasks = this.tasks.filter(function (todo) {
        return !todo.success;
      });
      console.log(this.tasks);

      axios.delete('http://bd-lab.info/api/todosDeleteCompleted').then(function (response) {}).catch(function (error) {
        _this7.error = response.response.data;
  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "col-sm-8 offset-sm-2" }, [
      _c("input", {
        ...
        attrs: { type: "text", placeholder: "Нажмите Enter чтобы добавить" },
        ...
        _c(
          ...
          [
            _c(
              ...
              _vm._l(_vm.todosFiltered, function(item, index) {
                return _c("tr", { key: item.id }, [
                  _c("td", { staticClass: "w-10" }, [
                    _c("input", {
                      ...
                      attrs: { type: "checkbox" },
                      domProps: {
                        checked: Array.isArray(item.success)
                          ? _vm._i(item.success, null) > -1
                          : item.success
                      },
                      on: {
                        click: function($event) {
                          _vm.editSuccess(item)
                        },
                        change: function($event) {
                          ...
                          if (Array.isArray($$a)) {
                            ...
                            if ($$el.checked) {
                              $$i < 0 &&
                                _vm.$set(item, "success", $$a.concat([$$v]))
                            } else {
                              $$i > -1 &&
                                _vm.$set(
                                  item,
      ...
      _c("div", { staticClass: "row" }, [
        ...
        _c("div", { staticClass: "col-md-6" }, [
          _c("span", [_vm._v("Не выполнено задач: " + _vm._s(_vm.remaining))])
        ])
      ]),
      _vm._v(" "),
      _c("hr", { staticClass: "myhr" }),
      _vm._v(" "),
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-md-1 offset-md-1 col-1 offset-1" }, [
          _c(
            "button",
            {
        ...
        _vm._v(" "),
        _c("div", { staticClass: "col-md-2 offset-md-3 col-2 offset-1" }, [
          _c(
            "button",
            {
        ...
        _vm._v(" "),
        _c("div", { staticClass: "col-md-2 offset-md-2 col-2 offset-1" }, [
          _c(
            "button",
            {
              class: { active: _vm.filter == "success" },
              on: {
                click: function($event) {
                  _vm.filter = "success"
                }
      ...
      _c(
        ...
        [
          _c("transition", { attrs: { name: "fade" } }, [
            _vm.showClearsuccessButton
              ? _c(
                  "button",
                  { staticClass: "mydel", on: { click: _vm.clearsuccess } },
                  [_vm._v("Удалить выполненные")]
                )
              : _vm._e()
          ])
        ],
